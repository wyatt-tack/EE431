...
C {code.sym} 160 -200 0 0 {name=spice only_toplevel=false value=".tran 1n 40n
.control
run
.endc"}
C {lab_wire.sym} -190 -30 0 0 {name=p4 sig_type=std_logic lab=A
}
C {lab_wire.sym} 130 -20 0 0 {name=p5 sig_type=std_logic lab=Y}
C {nand.sym} 40 -20 0 0 {name=x1}
...
C {lab_wire.sym} -140 -10 0 0 {name=p1 sig_type=std_logic lab=B
}
